import pytest
from utils.checks import get_endpoint_response, check_patch_requests, get_response_from_request_button
import json
from fixtures import browser, test_data, get_api


@pytest.mark.usefixtures('browser', 'test_data', 'get_api')
def test_update_patch_web(browser, test_data, get_api):
    """
    ...
    api_response = check_patch_requests(test_data, get_api)
